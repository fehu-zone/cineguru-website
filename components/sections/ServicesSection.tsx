      ...
      >
        ...
        <div className="services-canvas-container services-canvas-container--full">
          ...
          <div className={`services-canvas-hud services-canvas-hud-${activeIndex}`} key={`hud-cards-${activeIndex}`}>
            ...
            {/* 3 Floating Info Boxes around 3D scene (Only for activeIndex === 3 since Spline doesn't have 3D hotspots) */}
            {activeIndex === 3 && services.details[activeIndex].map((box, boxIndex) => (
              <div
                key={box.title}
                className={cn(
