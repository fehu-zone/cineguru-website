          ...
          return (
            <article className="reveal-on-scroll" style={{ "--stagger": index } as CSSProperties} key={project.id}>
              ...
              <div className="flex min-h-24 items-start justify-between gap-4 border-b border-surface/20 py-4">
                <div><p className="font-mono text-[0.56rem] uppercase tracking-[0.08em] text-surface/50">{content.type}</p><h3 className="mt-1 font-display text-[clamp(1.5rem,2.1vw,2.5rem)] [font-weight:560] leading-[1.04] tracking-[-0.035em]">{content.title}</h3></div>
            ...
            <article className="reveal-on-scroll" style={{ "--stagger": index } as CSSProperties} key={project.id}>
              ...
              >
                ...
                <div className="flex min-h-24 items-start justify-between gap-3 border-b border-surface/20 py-4">
                  <div><p className="font-mono text-[0.53rem] uppercase tracking-[0.08em] text-surface/50">{content.type}</p><h3 className="mt-1 font-display text-[clamp(1.25rem,1.5vw,1.8rem)] [font-weight:560] leading-[1.04] tracking-[-0.035em]">{content.title}</h3></div>
