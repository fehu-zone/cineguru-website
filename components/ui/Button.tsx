...
const sizeStyles: Record<ButtonSize, string> = {
  ...
  display: "min-h-[clamp(8.75rem,10vw,10rem)] flex-1 whitespace-nowrap px-6 py-6 font-body text-[clamp(1.9rem,3.8vw,4rem)] font-normal normal-case leading-none tracking-[-0.05em] max-[640px]:min-h-28 max-[640px]:px-5 max-[640px]:text-[clamp(1.25rem,6.5vw,2.2rem)] max-[640px]:tracking-[-0.03em]",
};
